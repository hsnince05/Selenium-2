...
//        1. SATIR 2. SUTUN
    ...
    //  Exceldeki toplam kullanilan satir sayisini bul
        int toplamSatirSayisi = sheet1.getLastRowNum()+1; // son satir numarasi. index 0 dan basladigi icin +1 ekledik
        System.out.println(toplamSatirSayisi);//11


    //  Kullanilan toplam satir sayisi ----- gorunurdeki
        int kullanilanToplamSatirSayisi = sheet1.getPhysicalNumberOfRows();
        System.out.println(kullanilanToplamSatirSayisi); // 1 den basliyo

//      COUNTR,CAPITALS key ve valuelari map a alip print etmek istiyorum
